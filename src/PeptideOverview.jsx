impor  { id:'tirzepatide', name:'Tirzepatide', fullName:'Tirzepatide (GIP/GLP-1 Dual Agonist)', categoryTag:'metabolic', category:'GLP-1 / Metabolic', icon:'📊', tagline:'First-in-class dual GIP/GLP-1 agonist — 20-22% weight loss', regulatoryStatus:'FDA-approved (Mounjaro: T2DM; Zepbound: obesity)', researchLevel:'very_high', isResearchOnly:false, summary:'First-in-class dual GIP and GLP-1 receptor co-agonist. Superior weight loss compared to semaglutide (20-22% body weight in SURMOUNT trials). GIP receptor activation adds insulin-potentiating and direct adipose tissue lipid-lowering effects beyond GLP-1 alone. Weekly subcutaneous injection.', mechanism:'GIP and GLP-1 receptor co-agonism · Insulin secretion potentiation · Glucagon suppression · Delayed gastric emptying · Central appetite suppression · Direct adipose tissue lipolysis via GIP receptor · Cardioprotective and hepatoprotective pathways', benefits:['20-22% body weight reduction (SURMOUNT-1 trial, N=2,539)','Superior glycemic control vs semaglutide in T2DM','Improved lipid profile and triglyceride reduction','Sleep apnea improvement (SURMOUNT-OSA trial)','Heart failure benefit (SUMMIT trial)','MASH/NAFLD liver fat reduction'], dosing:{ clinical:'2.5 mg/week SC starting dose, titrate by 2.5 mg every 4 weeks to 5-15 mg/week', cycle:'Ongoing chronic therapy for weight management or T2DM', routes:['Subcutaneous injection (weekly)'] }, sideEffects:'Nausea, diarrhea, vomiting during titration (typically resolve). Potential muscle mass loss with rapid weight reduction — pair with resistance training and adequate protein.', stacks:['Tirzepatide + resistance training + adequate protein (muscle preservation)','Tirzepatide + Tesamorelin (complementary mechanisms for metabolic syndrome: caloric intake vs visceral fat)'], humanEvidence:'SURMOUNT-1 (N=2,539): 20.9% weight loss at 72 weeks. SURMOUNT-2, 3, 4 trials. SURPASS trials for T2DM. FDA-approved 2022-2023.', pkHalfLife:'~5 days', bioavailability:'SC: ~80%' },
  { id:'sermorelin', name:'Sermorelin', fullName:'Sermorelin (GHRH 1-29)', categoryTag:'gh_axis', category:'GH Axis', icon:'💪', tagline:'First 29 amino acids of GHRH — longest safety record of any GH peptide', regulatoryStatus:'Compoundable by prescription. Previously FDA-approved (withdrawn 2008 for commercial reasons, not safety).', researchLevel:'high', isResearchOnly:false, summary:'The first 29 amino acids of endogenous GHRH. Previously FDA-approved under the brand name Geref. Has the longest clinical safety record of any GHRH analogue. Stimulates natural pulsatile GH release from the pituitary — less risk of desensitization than longer-acting analogues. Requires nightly dosing due to short half-life but produces physiological GH pulses.', mechanism:'GHRH receptor agonism on pituitary somatotrophs · Stimulates natural pulsatile GH production and release · Physiological GH pulsatility preserved · Shorter half-life than CJC-1295 — less receptor downregulation risk · IGF-1 elevation (dose-dependent)', benefits:['Natural pulsatile GH release — most physiological GH peptide','Improved slow-wave sleep quality and duration','Body composition improvement (gradual lean mass gain, fat reduction)','Anti-aging effects on skin, hair, and energy','Longest safety record of any GHRH analogue due to FDA approval history','Less suppression risk than longer-acting GHRH peptides'], dosing:{ clinical:'200-300 mcg SC before bed', community:'200-300 mcg SC nightly, fasted', cycle:'3-6 months minimum; can be run longer than CJC-1295 due to lower desensitization risk', routes:['Subcutaneous injection'] }, sideEffects:'Generally very well-tolerated. Mild flushing, tingling, headache possible. Injection site reactions. No significant adverse events in clinical use.', stacks:['Sermorelin + Ipamorelin (GHRH + GHRP combination for amplified GH pulse)','Sermorelin + BPC-157 (healing and recovery)'], humanEvidence:'FDA approval history (Geref). Multiple clinical studies in adults and children for GH deficiency. Long post-market safety record.', pkHalfLife:'<10 min', bioavailability:'SC: ~70%' },
  { id:'tesamorelin', name:'Tesamorelin', fullName:'Tesamorelin (Egrifta SV)', categoryTag:'gh_axis', category:'GH Axis / Metabolic', icon:'🎯', tagline:'Only FDA-approved GHRH analog — visceral fat reduction with preserved GH pulsatility', regulatoryStatus:'FDA-approved (Egrifta SV) for HIV lipodystrophy visceral fat. Off-label: NAFLD/MASLD, body composition, cognitive aging. Compoundable by prescription.', researchLevel:'high', isResearchOnly:false, summary:'Stabilized synthetic analog of human GHRH(1-44) with N-terminal trans-3-hexenoic acid modification conferring DPP-IV resistance. FDA-approved 2010 for visceral fat reduction in HIV-associated lipodystrophy. Unlike CJC-1295 with DAC, tesamorelin generates a discrete pulsatile GH pulse that clears and synergizes with the natural nocturnal slow-wave-sleep GH burst. Six peer-reviewed human trials including Phase III (N=806) establish 15-18% VAT reduction, cognitive benefits, liver enzyme normalization, and glycemic safety in T2DM.', mechanism:'GHRH receptor agonism on pituitary somatotrophs — pulsatile GH release. Higher GH receptor density in visceral adipose tissue (VAT) vs subcutaneous fat drives selective visceral lipolysis. IGF-1 elevation +117-181% within physiological range. Preserves negative IGF-1 feedback loop — key advantage over exogenous rhGH. GH pulsatility confirmed preserved via AutoDecon deconvolution (Stanley 2011, JCEM).', benefits:['[Verified — High] VAT reduction 15-18% over 26 weeks in Phase III RCT (N=806, P<0.001)','GH pulsatility preserved — pulse area increased, frequency unchanged (Stanley 2011)','VAT reduction in non-HIV obese: -19% at 12 months (Makimura 2012, N=60)','Carotid IMT reduction -6%, P=0.02 — cardiovascular benefit outside HIV','Cognitive function: executive function effect size f=0.37, P=.005 (Baker 2012, N=152 MCI+healthy)','Liver enzyme improvement: ALT -18% in VAT responders (Fourman 2017, N=806)','Glycemic safety confirmed in T2DM at 12 weeks (Clemmons 2017, N=53)'], dosing:{ clinical:'2 mg SC once daily (FDA label) · Evening/pre-bed, fasted state (2+ hours post-meal)', community:'1-2 mg SC once daily off-label body composition or NAFLD', acute:'Start 1 mg SC daily, titrate to 2 mg over 2-4 weeks to reduce side effects', cycle:'12-26 weeks off-label body composition; continuous per FDA label for HIV lipodystrophy; minimum 12 weeks to assess NAFLD response', routes:['Subcutaneous injection'] }, sideEffects:'Injection site reactions (common — rotate sites). Arthralgias/myalgias (5-10%, dose-related, titrate to reduce). Peripheral edema (common, self-limiting, reduce sodium). Transient fasting glucose increase (monitor in T2DM). Compliance 97-99.5% in trials. Contraindicated in active malignancy.', stacks:['Tesamorelin solo for NAFLD/visceral fat (robust GH pulses alone — no GHRP needed)','Tesamorelin + Ipamorelin 200-300 mcg pre-bed (if IGF-1 suboptimal on tesamorelin alone)','Tesamorelin + Semaglutide or Tirzepatide (metabolic syndrome: complementary mechanisms)','MK-677 + Tesamorelin (highest IGF-1 combination — lab monitoring essential)'], humanEvidence:'6 peer-reviewed human studies. Phase III RCT N=806 (Falutz 2007/2010). Cognitive RCT N=152 (Baker 2012). GH pulsatility N=13 (Stanley 2011). Non-HIV obese RCT N=60 (Makimura 2012). Liver enzymes N=806 (Fourman 2017). T2DM safety RCT N=53 (Clemmons 2017). FDA-approved 2010.', pkHalfLife:'26-38 min', bioavailability:'SC: high (DPP-IV resistant)' },
  { id:'kisspeptin10', name:'Kisspeptin-10', fullName:'Kisspeptin-10 (KP-10)', categoryTag:'fertility', category:'Fertility & Hormonal', icon:'🧬', tagline:'HPG-axis upstream trigger — stimulates natural LH and testosterone', regulatoryStatus:'Investigational. Not FDA-approved. Research use only.', researchLevel:'moderate', isResearchOnly:true, summary:'Endogenous neuropeptide that stimulates GnRH release from the hypothalamus, driving downstream LH and FSH secretion from the pituitary. Acts one step upstream of Gonadorelin in the HPG axis. Used for fertility restoration, testosterone optimization, and sexual function improvement via a central brain mechanism.', mechanism:'KISS1R receptor agonism on GnRH neurons in the hypothalamus · GnRH pulse triggering → pituitary LH/FSH surge → gonadal steroidogenesis · Central dopaminergic and olfactory sexual signaling · Upstream of both GnRH and LH in the hormonal cascade', benefits:['Stimulates natural LH and testosterone production','Fertility enhancement: oocyte maturation, sperm production stimulation','HPG axis restoration in hypogonadotropic hypogonadism','Sexual desire and arousal (central brain mechanism)','No direct testicular stimulation — physiological upstream approach'], dosing:{ clinical:'9.6 nmol/kg IV (published clinical trial dose) or 50-100 mcg SC', cycle:'Pulsatile protocols required; design varies by indication and goal', routes:['Subcutaneous injection','Intravenous (clinical trials only)'] }, sideEffects:'Generally well-tolerated in clinical trials. Transient LH surge. Limited long-term safety data available.', stacks:['Kisspeptin-10 + Gonadorelin (dual HPG axis stimulation protocol)','Kisspeptin-10 + PT-141 (central HPG + central desire)'], humanEvidence:'Multiple human clinical trials for LH stimulation and fertility. Jayasena et al. 2014 (J Clin Invest) for sexual function. Pulsatile IV protocols studied in hypothalamic amenorrhea and male hypogonadism.', pkHalfLife:'~2-4 min', bioavailability:'IV: 100%; SC: ~60%' },
  { id:'hcg', name:'HCG', fullName:'Human Chorionic Gonadotropin (hCG)', categoryTag:'fertility', category:'Hormonal / Fertility', icon:'🧬', tagline:'LH mimic — testicular function maintenance and fertility on TRT', regulatoryStatus:'FDA-approved (Pregnyl, Novarel) for hypogonadotropic hypogonadism in males, ovulation induction in females, and cryptorchidism. TRT adjunct use is off-label. Compounding supply limited post-2024 FDA enforcement — gonadorelin is primary 2026 alternative.', researchLevel:'high', isResearchOnly:false, summary:'244-amino-acid glycoprotein hormone (LH mimic) produced by the placenta during pregnancy. In men, binds directly to LH receptors on testicular Leydig cells, bypassing the pituitary entirely. Stimulates intratesticular testosterone (ITT) and maintains spermatogenesis during TRT. In hypogonadotropic hypogonadism (HH) populations: testosterone normalization from 0.9 to 15.1 nmol/L (P<0.001, Liu 2016, N=223). As of 2026, HCG compounding availability is limited — gonadorelin has become the primary TRT adjunct.', mechanism:'Direct LH receptor agonism on testicular Leydig cells · Activates adenylyl cyclase → cAMP → steroidogenic enzyme upregulation → intratesticular testosterone (ITT) · Bypasses hypothalamic-pituitary signaling entirely · ITT orders of magnitude higher than serum testosterone — essential for Sertoli cell and spermatogenesis support · Terminal half-life ~33-37 hours (biological effect 3-5 days per injection) · Higher estrogen conversion than gonadorelin due to stronger direct Leydig stimulation', benefits:['[Verified] Testosterone normalization in HH: 0.9 → 15.1 nmol/L (P<0.001, Liu 2016, N=223)','[Verified] Testicular volume restoration: 2.1 → 8.1 mL (P<0.001) in HH patients','[Verified] Spermatogenesis induction with FSH: 77.8% success in Phase III (Nieschlag 2017, N=18)','[Verified] Fertility: 56% paternity rate in married HH patients (Liu 2016)','[Speculation] TRT adjunct: preserves testicular size, fertility potential, and ITT — community standard 250-500 IU 2-3x/week'], dosing:{ clinical:'HH therapy: 1,500-3,000 IU SC/IM 2x/week (Verified — Phase III). TRT adjunct: 250-500 IU SC 2-3x/week (Speculation — community standard)', cycle:'HH fertility: 6-18+ months. TRT adjunct: continuous with TRT. Effects reverse within months of stopping.', routes:['Subcutaneous injection','Intramuscular injection (clinical trials)'] }, sideEffects:'Well-tolerated at TRT-adjunct doses. Estradiol elevation (higher aromatization risk than gonadorelin — monitor E2). Gynecomastia 7% at HH doses (Liu 2016). Acne 9%. Pregnancy test cross-reactivity: positive for 7-14 days post-injection. CRITICAL: dosed in International Units (IU) not milligrams — dosing errors possible.', stacks:['HCG + Testosterone TRT (standard TRT adjunct for testicular preservation)','HCG + HMG or FSH (complete spermatogenesis induction in HH — clinical supervision required)'], humanEvidence:'4 clinical studies: Phase III HCG+corifollitropin alfa (Nieschlag 2017, N=18); retrospective cohort HCG+HMG (Liu 2016, N=223); GnRH maintenance (Delemarre-van de Waal 2004, N=68); TRT review (Hong & Ahn 2007). No RCT for TRT adjunct use specifically.', pkHalfLife:'~33-37 hours', bioavailability:'SC/IM: ~90%' },
  { id:'glutathione', name:'Glutathione', fullName:'Glutathione (GSH)', categoryTag:'longevity', category:'Antioxidant / Longevity', icon:'⚡', tagline:'Master antioxidant and hepatic detoxifier — injectable for systemic effect', regulatoryStatus:'Injectable glutathione NOT FDA-approved for any indication. Available via 503A compounding pharmacies with physician prescription. Oral GSH supplements: DSHEA dietary supplement (near-zero systemic bioavailability).', researchLevel:'moderate', isResearchOnly:false, summary:'Tripeptide (gamma-Glutamyl-Cysteinyl-Glycine) and the body's most abundant endogenous antioxidant. Oral capsules are largely placebo for systemic effect (<5% bioavailability; degraded in stomach). Injectable IV or SC routes reliably elevate circulating and tissue GSH. Liposomal oral forms (15-30% bioavailability) are the best non-injectable option. CRITICAL: Unlike most peptides, reconstituted glutathione is sensitive to oxidation — use within 24 hours.', mechanism:'Reactive oxygen species neutralization (GSH → GSSG redox cycle, regenerated by glutathione reductase/NADPH) · Phase II hepatic detoxification: conjugates toxins for biliary/renal excretion · Tyrosinase inhibition → melanin reduction (mechanism of skin-lightening use) · Lymphocyte proliferation and cytokine production regulation · Parkinson's neuroprotection: IV glutathione improved motor scores in early PD (Sechi 1996)', benefits:['Systemic antioxidant defense — most reliable via injectable routes','Phase II hepatic detoxification support','NAFLD/liver function: oral GSH 300 mg/day reduced ALT and hepatic fat markers (Honda 2017, N=29)','Parkinson's disease motor function improvement with IV glutathione (Sechi 1996)','Liposomal oral form elevates whole-blood GSH and immune markers (Sinha 2018, 6-month study)','Post-illness and Long COVID recovery support (oxidative stress documented)'], dosing:{ clinical:'SC: 200-600 mg, 1-3x/week. IV: 600-1,200 mg per session, slow push over 5-15 minutes', community:'SC: 200-400 mg 2-3x/week at home; IV: 600-1,200 mg at clinic', cycle:'No standard cycle. Continuous for longevity protocols; on-demand for acute indications.', routes:['Intravenous (gold standard)','Subcutaneous injection','Intramuscular','Liposomal oral (best non-injectable option)'] }, sideEffects:'Well-tolerated. Mild injection site stinging (low pH). Headache rare. Transient lightheadedness with fast IV push — slow to 5-15 minutes. Sulfur-like taste with sublingual or nasal forms. CRITICAL STABILITY: Use within 24 hours of reconstitution — oxidation degrades active form. Do not stockpile pre-mixed.', stacks:['Glutathione + NAD+ (canonical longevity stack — inject separately, not same syringe)','Glutathione + Vitamin C high-dose IV (Vitamin C regenerates oxidized GSH back to active form)','Glutathione + Alpha-Lipoic Acid oral (ALA is a GSH recycling cofactor)','Glutathione + Thymosin Alpha-1 (immune and antioxidant post-illness protocol)'], humanEvidence:'Sechi 1996 (IV GSH in early Parkinson's, motor improvement). Allen & Bradley 2011 (oral GSH reduced oxidative stress biomarkers). Sinha 2018 (liposomal GSH elevated body stores — Eur J Clin Nutr). Honda 2017 (oral GSH in NAFLD — BMC Gastroenterol). Pizzorno 2014 review.', pkHalfLife:'~10 min (IV plasma); intracellular effects longer due to GSH recycling', bioavailability:'IV: 100%; SC: moderate; oral: <5%; liposomal: 15-30%' },
  { id:'nad_plus', name:'NAD+', fullName:'Nicotinamide Adenine Dinucleotide (NAD+)', categoryTag:'mitochondrial', category:'Longevity / Mitochondrial', icon:'⚡', tagline:'Central longevity coenzyme — fuels sirtuins, DNA repair, and mitochondrial function', regulatoryStatus:'Injectable NAD+ NOT FDA-approved. Available via 503A compounding pharmacies with physician prescription. Oral NAD+ capsules widely sold as dietary supplements but have near-zero systemic bioavailability. NMN and NR precursors: NR is FDA-recognized supplement; NMN is in regulatory gray zone.', researchLevel:'moderate', isResearchOnly:false, summary:'Coenzyme found in every living cell, existing as oxidized (NAD+) and reduced (NADH) forms. Cellular NAD+ falls roughly 50% by middle age (Massudi 2012, human skin biopsies). When NAD+ is low: sirtuins go quiet, PARP-driven DNA repair slows, CD38 continues hydrolyzing remaining NAD+, and mitochondria operate at reduced redox capacity. Oral NAD+ capsules are functionally placebo for systemic effect — injectable routes (IV or SC) reliably raise circulating NAD+. The flush is rate-dependent (not dose-total dependent) — slowing the IV drip resolves it. Methyl donor depletion is the most important clinical concern with chronic high-dose IV use.', mechanism:'Sirtuin (SIRT1-SIRT7) activation: NAD+-dependent deacetylases regulating metabolic gene expression and stress response (Imai & Guarente 2014) · PARP enzyme substrate for DNA damage repair · CD38 ectoenzyme competition (primary driver of age-related NAD+ decline) · Redox cofactor for glycolysis, TCA cycle, beta-oxidation, and electron transport chain · NMN and NR precursors raise NAD+ via salvage pathway', benefits:['Age-related NAD+ decline confirmed in humans: ~50% reduction by middle age (Massudi 2012)','NR precursor reliably raises whole-blood NAD+ in healthy older adults (Martens 2018, Nat Commun)','NMN increased muscle insulin sensitivity in prediabetic postmenopausal women (Yoshino 2021, Science)','Injectable NAD+ raises circulating NAD+ effectively — required for meaningful elevation (Mehmel 2020)','Sirtuin activation scales directly with NAD+ availability (Imai & Guarente 2014, Trends Cell Biol)','[Speculation] Human longevity endpoints: no RCT has demonstrated lifespan extension'], dosing:{ clinical:'SC: 50-100 mg daily or 100-200 mg 3x/week. IV: 250-1,000 mg per session over 1-3 hours (slow — prevents flush)', community:'SC home use: 100 mg every other day from 500 mg vial (~$20/dose vs $300-500/IV session)', cycle:'Continuous for longevity protocols. IV: loading phase 1-3x/week, then monthly maintenance.', routes:['Intravenous (highest acute peak)','Subcutaneous injection (steady elevation at 1/10th IV cost)','Intramuscular'] }, sideEffects:'NAD+ Flush: facial warmth, chest pressure, mild anxiety with rapid IV — rate-dependent, not dose-total dependent. Slow drip resolves it. SC produces almost no flushing. Methyl donor depletion: NAD+ catabolism consumes methyl groups → depressive or anxious tail 2-4 days post-IV. Manage with TMG (trimethylglycine) 500-1,000 mg daily. Injection site sting (mildly acidic solution).', stacks:['NAD+ + Glutathione (canonical longevity stack — inject separately, complementary redox/energy roles)','NAD+ + TMG/betaine (mandatory methyl donor support — prevents post-IV mood dip)','NAD+ + MOTS-c (mitochondrial biogenesis complement)','NAD+ + Epithalon (telomerase and pineal axis longevity protocol)'], humanEvidence:'Massudi 2012 (50% NAD+ decline in human skin biopsies, PLoS One). Martens 2018 (NR in healthy older adults, Nat Commun). Yoshino 2021 (NMN insulin sensitivity, Science). Mehmel 2020 (injection bioavailability review, Nutrients). Imai & Guarente 2014 (sirtuin-NAD+ axis review, Trends Cell Biol).', pkHalfLife:'~10 min (IV plasma); intracellular effects longer', bioavailability:'IV: 100%; SC: moderate; oral (NAD+ itself): near zero' },
  { id:'gonadorelin', name:'Gonadorelin', fullName:'Gonadorelin (Synthetic GnRH)', categoryTag:'fertility', category:'Hormonal / Fertility', icon:'🧬', tagline:'Synthetic GnRH — primary HCG alternative for testicular preservation on TRT in 2026', regulatoryStatus:'Originally FDA-approved as Factrel and Lutrepulse (both discontinued). Current TRT-adjunct use off-label via 503A compounding. Significantly easier to source than HCG as of 2026 following FDA compounding enforcement. WADA Prohibited List 2026.', researchLevel:'moderate', isResearchOnly:false, summary:'Synthetic 10-amino-acid peptide identical to endogenous GnRH — the upstream hormonal signal in the HPG axis. Works UPSTREAM of HCG: stimulates the pituitary to release LH and FSH naturally, which then stimulate the testicles. HCG bypasses the pituitary and acts directly on Leydig cells. Half-life 2-10 minutes — pulsatile dosing required (2-3x daily) to mimic natural GnRH pulses. Continuous dosing would paradoxically SUPPRESS the pituitary (same principle as leuprolide in chemical castration). Most TRT clinics have defaulted to gonadorelin for new patients in 2026.', mechanism:'GnRH receptor agonism on pituitary gonadotroph cells → LH and FSH synthesis and release → Leydig cell testosterone (ITT) and Sertoli cell spermatogenesis support · Works upstream of both HCG and testosterone · Pulsatile requirement: half-life 2-10 minutes; continuous exposure causes receptor downregulation (opposite of desired effect) · Lower estrogen conversion than HCG — more modest ITT stimulation → less aromatization → many users do not need an aromatase inhibitor', benefits:['Testicular function preservation during TRT (HCG mechanism equivalent, upstream approach)','Lower estrogen conversion than HCG — fewer aromatase inhibitor requirements','No pregnancy test cross-reactivity (HCG causes false positives for 7-14 days; gonadorelin does not)','Better 2026 compounding availability than HCG','FSH stimulation included (HCG stimulates LH pathway only)'], dosing:{ clinical:'100-300 mcg SC, 2-3 times daily (TRT adjunct standard). Starting: 200 mcg SC twice daily (morning and evening)', cycle:'Continuous with TRT for testicular preservation. Fertility protocols: 300+ mcg 3-4x daily under reproductive specialist supervision.', routes:['Subcutaneous injection'] }, sideEffects:'Well-tolerated at TRT-adjunct doses. Mild flushing at injection time (transient). Headache rare. Less estrogen-related side effects than HCG (less water retention, less gynecomastia risk). Requires 14-21 injections per week (vs 2-3 for HCG) — injection burden is the primary limitation.', stacks:['Gonadorelin + Testosterone TRT (standard 2026 TRT adjunct for testicular preservation)','Gonadorelin + FSH/HMG (active fertility protocols under reproductive specialist — for men wanting to conceive)'], humanEvidence:'Decades of clinical use as diagnostic GnRH stimulation test (Factrel). Hsieh 2013 (J Urol) and Coviello 2005 (JCEM) support HPG-axis preservation principle. Bhasin 2018 Endocrine Society guideline. TRT-adjunct use extrapolated from established physiology — no dedicated RCT for this indication.', pkHalfLife:'2-10 min', bioavailability:'SC: ~60-80%' },
  { id:'mk677', name:'MK-677', fullName:'MK-677 (Ibutamoren Mesylate)', categoryTag:'gh_axis', category:'GH Axis / Oral Secretagogue', icon:'💪', tagline:'Only oral GH secretagogue — once-daily capsule with 24-hour GH axis effect', regulatoryStatus:'Investigational — NOT FDA-approved for any indication. Some 503A compounding pharmacies dispense capsules off-label under physician prescription (varies by state). WADA Prohibited List 2026. NOT a peptide — small-molecule spiroindoline GHS-R1a agonist.', researchLevel:'moderate', isResearchOnly:true, summary:'The only major orally bioavailable growth hormone secretagogue in widespread use. Every other GH peptide (Sermorelin, CJC-1295, Tesamorelin, Ipamorelin) requires injection. MK-677 is a once-daily oral capsule. Plasma half-life 4-6 hours; biological effect on GH/IGF-1 axis lasts ~24 hours. Pivotal evidence: Nass et al. Ann Intern Med 2008 (12-month RCT in elderly) — IGF-1 1.5-2x baseline sustained without tachyphylaxis, fat-free mass +3 kg, HbA1c +0.3%. CRITICAL SAFETY SIGNAL: Clinical trial in elderly hip-fracture patients halted 2007 due to CHF event imbalance — meaningful caution against use in anyone with cardiovascular disease.', mechanism:'GHS-R1a (ghrelin receptor) agonism on pituitary somatotrophs and hypothalamic neurons — mimics endogenous ghrelin · Pulsatile GH secretion without meaningful pituitary suppression (confirmed in 12-month Nass trial) · IGF-1 elevation 1.5-2x baseline at 25 mg/day, sustained without tachyphylaxis · Appetite increase (ghrelin's most reliable orexigenic effect) · Slow-wave sleep duration increase in some users · CORTISOL: modest ACTH/prolactin elevation via hypothalamic cross-talk — much less than GHRP-6 or Hexarelin', benefits:['IGF-1 sustained 1.5-2x baseline over 12 months without tachyphylaxis (Nass 2008)','Fat-free mass +3 kg at 12 months in elderly (Nass 2008) — meaningful for older adults','Oral bioavailability — eliminates injection barrier (unique in GH secretagogue class)','Bone turnover markers increased in healthy and functionally impaired elderly (Murphy 1999)','No meaningful pituitary suppression — IGF-1 returns to baseline within 2-4 weeks of stopping','Improved slow-wave sleep quality reported (GH pulse alignment with sleep architecture)'], dosing:{ clinical:'25 mg once daily (Nass 2008 validated trial dose)', community:'Start 10 mg once daily x 2-4 weeks, titrate to 15-25 mg once daily', cycle:'8-16 weeks on, 4-8 weeks off (side-effect management rationale: water retention, glucose). Minimum 4-week off period. Continuous use requires quarterly lab monitoring.', routes:['Oral capsule'] }, sideEffects:'CRITICAL: CHF imbalance in elderly hip-fracture trial (Adunsky 2011) — avoid in cardiovascular disease. Increased appetite (very common — ghrelin effect). Water retention/edema (common, onset 1-3 weeks — reduce sodium, lower dose). Morning grogginess/lethargy (common — try morning dosing). Vivid dreams (common). HbA1c +0.3% at 25 mg over 12 months (Nass 2008) — monitor fasting glucose. Numbness/paresthesias at higher doses (IGF-1-mediated).', stacks:['MK-677 + Tesamorelin (highest IGF-1 combination — lab monitoring essential for glucose and IGF-1)','MK-677 + CJC-1295/Ipamorelin (not recommended — redundant goals, additive water retention and glucose impact)'], humanEvidence:'Nass 2008 (12-month RCT, Ann Intern Med — primary efficacy/safety). Adunsky 2011 (halted hip-fracture Phase IIb, CHF signal). Murphy 1999 (bone turnover, J Bone Miner Res). Sevigny 2008 (Alzheimer's trial — no effect on AD progression, Neurology). FDA investigational.', pkHalfLife:'4-6 hours (plasma); ~24 hours (GH/IGF-1 biological effect)', bioavailability:'Oral: ~60-70% (survives GI digestion — unique for GH secretagogues)' },
t { useState, useRef, useEffect } from "react";
